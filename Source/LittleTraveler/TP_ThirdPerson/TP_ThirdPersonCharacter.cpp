...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Turn", this, &ATP_ThirdPersonCharacter::Turn);
...
void ATP_ThirdPersonCharacter::Turn(float Val)
{
	if (curLevel != 0)
		AddControllerYawInput(Val);
}

void ATP_ThirdPersonCharacter::LookUp(float Val)
{
	if (curLevel != 0)
